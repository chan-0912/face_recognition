...
#can add as many people as we want and their pictures in known-people
anne=FaceRec('./knownpeople/anne.jpeg','./stranger','anne')
chanchal=FaceRec('./knownpeople/chanchal.jpeg','./stranger','chanchal')